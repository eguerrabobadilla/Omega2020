import { Component, ElementRef, ViewChild, Renderer2, ɵCodegenComponentFactoryResolver, OnInit } from '@angular/core';
...
@Component({
  selector: 'app-home-universidad',
  templateUrl: './home-universidad.page.html',
  styleUrls: ['./home-universidad.page.scss'],
})
export class HomeUniversidadPage implements OnInit {
  ...
  ngAfterViewInit() {
   ...
   //  this.statusBar.overlaysWebView(true);
    ...
    async ngOnInit() {
      ...
      this.iconos = ['books_icono.svg','account_icono.svg', 'support_icono.svg'];
      this.headersText = ['Books', 'Account', 'Support'];
      this.tabs = ['Todos', 'Inglés'  , 'Español'];
