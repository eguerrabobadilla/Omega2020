...
import { HomeUniversidadPageRoutingModule } from './home-universidad-routing.module';

import { HomeUniversidadPage } from './home-universidad.page';
...
@NgModule({
  ...
  imports: [
    ...
    HomeUniversidadPageRoutingModule,
    MbscModule,  
    CommonModule,
    FormsModule,
    IonicModule,
  ...
  declarations: [HomeUniversidadPage]
})
export class HomeUniversidadPageModule {}
